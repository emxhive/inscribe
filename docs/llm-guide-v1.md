# Inscribe V1 Legacy LLM Guide

This is the legacy V1 guide. The current main guide is V2-only and lives in llm-guide.md.

Use this file only when explicitly working with legacy V1 `$inscribe` blocks.

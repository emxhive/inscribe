...
export const KEYWORD_END_OCCURRENCE = 'END_OCCURRENCE';
export const KEYWORD_RANGE_CONTAINS = 'RANGE_CONTAINS';
export const KEYWORD_RANGE_LINE_CONTAINS_ALL = 'RANGE_LINE_CONTAINS_ALL';
...
export const DIRECTIVE_END_OCCURRENCE = `${KEYWORD_END_OCCURRENCE}:`;
export const DIRECTIVE_RANGE_CONTAINS = `${KEYWORD_RANGE_CONTAINS}:`;
export const DIRECTIVE_RANGE_LINE_CONTAINS_ALL = `${KEYWORD_RANGE_LINE_CONTAINS_ALL}:`;
...
export const DIRECTIVE_KEYS = [
  ...
  KEYWORD_END_OCCURRENCE,
  KEYWORD_RANGE_CONTAINS,
  KEYWORD_RANGE_LINE_CONTAINS_ALL,
  KEYWORD_NAME,
] as const;
